...
**Рекомендуемый порядок следующего спринта (по умолчанию): Phase 18** (инкрементальная корзина) **→** деньги/webhook **или** CRUD строк заказа в админке — по приоритету бизнеса.

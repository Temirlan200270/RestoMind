# RestoMind — детальный архив изменений (до реструктуризации 2026-05-26)

Полная пошаговая история эпиков с файлами, миграциями и тестами. Для текущих релизов см. корневой [CHANGELOG.md](../CHANGELOG.md).
